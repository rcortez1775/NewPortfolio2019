            ...
            <div>
                <div className="projectContainer">
                    <div className="box3 keepPUPBox">
                        ...
                        <p className="appDescription">The keepPUP App allows users to keep up with their furry friends. 
                            Track when you feed and walk your dog with push notifications blah blah blah. 
                            <span className="boldText">Made with:</span> JavaScript, Node.js, Express, MySQL and Material-UI
                        </p>
                    </div>
